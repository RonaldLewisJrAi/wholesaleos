...
const Signup = () => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            console.log("[WHOLESALEOS TELEMETRY] Executing supabase.auth.signUp...");
            ...
            console.log("[WHOLESALEOS TELEMETRY] supabase.auth.signUp completed.");

            if (signUpError) {
                console.error("[WHOLESALEOS TELEMETRY] signUpError:", signUpError);
                throw signUpError;
            }

            console.log("[WHOLESALEOS TELEMETRY] session returned from signUp?", !!authData.session);
